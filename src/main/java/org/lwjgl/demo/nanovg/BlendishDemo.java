...
class UIData extends Struct implements NativeResource {
    ...
    @Nullable
    public static UIHandler nhandler(long struct)              { return UIHandler.createSafe(memGetAddress(struct + UIData.HANDLER)); }
...
class UIRectData extends Struct implements NativeResource {
    ...
    @Nullable
    public static ByteBuffer nlabel(long struct)   { return memByteBufferNT1Safe(memGetAddress(struct + UIRectData.LABEL)); }
    @Nullable
    public static String nlabelString(long struct) { return memUTF8Safe(memGetAddress(struct + UIRectData.LABEL)); }
...
class UIButtonData extends Struct implements NativeResource {
    ...
    @Nullable
    public static ByteBuffer nlabel(long struct)   { return memByteBufferNT1Safe(memGetAddress(struct + UIButtonData.LABEL)); }
    @Nullable
    public static String nlabelString(long struct) { return memUTF8Safe(memGetAddress(struct + UIButtonData.LABEL)); }
...
class UICheckData extends Struct implements NativeResource {
    ...
    @Nullable
    public static ByteBuffer nlabel(long struct)     { return memByteBufferNT1Safe(memGetAddress(struct + UICheckData.LABEL)); }
    @Nullable
    public static String nlabelString(long struct)   { return memUTF8Safe(memGetAddress(struct + UICheckData.LABEL)); }
...
class UIRadioData extends Struct implements NativeResource {
    ...
    @Nullable
    public static ByteBuffer nlabel(long struct)    { return memByteBufferNT1Safe(memGetAddress(struct + UIRadioData.LABEL)); }
    @Nullable
    public static String nlabelString(long struct)  { return memUTF8Safe(memGetAddress(struct + UIRadioData.LABEL)); }
...
class UISliderData extends Struct implements NativeResource {
    ...
    @Nullable
    public static ByteBuffer nlabel(long struct)         { return memByteBufferNT1Safe(memGetAddress(struct + UISliderData.LABEL)); }
    @Nullable
    public static String nlabelString(long struct)       { return memUTF8Safe(memGetAddress(struct + UISliderData.LABEL)); }
...
class UITextData extends Struct implements NativeResource {
    ...
    @Nullable
    public static ByteBuffer ntext(long struct)   { return memByteBufferNT1Safe(memGetAddress(struct + UITextData.TEXT)); }
    @Nullable
    public static String ntextString(long struct) { return memUTF8Safe(memGetAddress(struct + UITextData.TEXT)); }
